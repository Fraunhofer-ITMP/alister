...
1.  As 'Analyte search' provides a more detailed investigation of analytes, you can select them individually in the drop-down menu. It is possible to type in the name of your analyte of interest, so you don't have to scroll through all of them.
2.  As in 'Sample search' you can now add your pre-analytical conditions, starting with the temperature during processing. Click 'Other temperature after centrifugation' if the processing temperature varied before and after centrifugation.
